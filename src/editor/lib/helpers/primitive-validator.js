...
var validateFormat, validatePopulated, validators;
...
validatePopulated = function(value) {
...
validateFormat = function(fhirType, value) {
  var validator;
...
module.exports.isValid = function(fhirType, value, failBlank) {
  var badFormat;
